...
<div class="walletsWrapper row" data-user="{{ $user->id }}">
    <div class="col-md-3 col-sm-3 managementNav">
        @foreach($wallets as $wallet)
            ...
            <div class="eachWallet @if ($wallet->registry['slug'] == 'Wallet-Ewallet') active @endif" data-wallet="{{ $wallet->moduleId }}">
    ...
    <div class="walletHolder col-md-9 col-sm-9">
        @foreach($wallets as $wallet)
            ...
            <div class="wallet @if ($wallet->registry['slug'] == 'Wallet-Ewallet') active @endif" data-target="{{ $wallet->moduleId }}">
