                ...
                <table class="content_section" width="100%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td class="content_cell header_c active_b brt pt pb"
                            ...
                            <!-- col-2-4 -->
                            <div class="email_row"
                                 style="box-sizing: border-box;font-size: 0;display: block;width: 100%;vertical-align: top;clear: both;line-height: inherit;min-width: 0 !important;max-width: 600px !important;">
                                <img src="{{asset('images/LogoNetworkRedBlack.png')}}" style="max-width: 250px; margin-bottom: 30px;"><br/>
                                <h4 style="width: 100%; font-size: 24px; margin-left: -15px; font-family: sans-serif;text-align: center;padding-left: 10px;padding-right: 10px;">ATTENTION! IMMEDIATE ACTION REQUIRED. PAYMENT EEA.</h4>
                                <div class="col_12"
                                    ...
                                    <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                style="box-sizing: border-box;vertical-align: top;width: 100%;min-width: 100%;padding-top: 22px;padding-bottom: 0;font-family: Helvetica, Arial, sans-serif;font-size: 16px;line-height: 150%;mso-line-height-rule: exactly;text-align: left;padding-left: 16px;padding-right: 16px;">
                                        ...
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                style="box-sizing: border-box;vertical-align: top;width: 100%;min-width: 100%;padding-top: 1px;padding-bottom: 0;font-family: Helvetica, Arial, sans-serif;font-size: 16px;line-height: 150%;mso-line-height-rule: exactly;text-align: left;padding-left: 16px;padding-right: 16px;">
                                                (USE THIS ID NUMBER IN YOUR REFERENCE SECTION OF YOUR PAYMENT)
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                style="box-sizing: border-box;vertical-align: top;width: 100%;min-width: 100%;padding-top: 22px;padding-bottom: 0;font-family: Helvetica, Arial, sans-serif;font-size: 16px;line-height: 150%;mso-line-height-rule: exactly;text-align: left;padding-left: 16px;padding-right: 16px;">
                                                You have chosen to pay with IBAN. Please make sure to immediately complete this transaction via your bank to make sure your position is consolidated.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                style="box-sizing: border-box;vertical-align: top;width: 100%;min-width: 100%;padding-top: 22px;padding-bottom: 0;font-family: Helvetica, Arial, sans-serif;font-size: 16px;line-height: 150%;mso-line-height-rule: exactly;text-align: left;padding-left: 16px;padding-right: 16px;">
                                                Your position will expire within 7 days, if payment is not received.
                                        ...
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                ...
                                                Address: No.5, 17/F, Bonham Trade Centre, 50 Bonham Strand, Sheung Wan <br>
                                                Country: Hong Kong
                                        ...
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                style="box-sizing: border-box;vertical-align: top;width: 100%;min-width: 100%;padding-top: 22px;padding-bottom: 0;font-family: Helvetica, Arial, sans-serif;font-size: 16px;line-height: 150%;mso-line-height-rule: exactly;text-align: left;padding-left: 16px;padding-right: 16px;">
                                                IBAN Number: BE21 9670 5753 4403 <br>
                                                Bank Code: TRWIBEB1XXX <br>
                                                Bank code: (/ BIC): TRWIBEB1XXX <br>
                                                : BE21 9670 5753 4403
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                style="box-sizing: border-box;vertical-align: top;width: 100%;min-width: 100%;padding-top: 22px;padding-bottom: 0;font-family: Helvetica, Arial, sans-serif;font-size: 16px;line-height: 150%;mso-line-height-rule: exactly;text-align: left;padding-left: 16px;padding-right: 16px;font-weight: bold; text-decoration: underline; color: red;">
                                                REFERENCE: {{$user->customer_id}}<br>
                                                USE ONLY YOUR 6-DIGIT ELYSIUM ID NUMBER AS REFERENCE.<br>
                                                DO NOT ADD SPACES OR LETTERS/DOTS/SIGNS.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                ...
                                                1000<br>
                                                Belgium<br><br>
                                                Please note that you have to use the reference when paying with the Transferwise website. 
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
