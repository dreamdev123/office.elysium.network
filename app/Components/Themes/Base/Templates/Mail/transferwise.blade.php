                    ...
                    <tr>
                        <td class="content_cell header_c active_b brt pt pb"
                            ...
                            <div class="email_row"
                                ...
                                <img src="LogoNetworkRedBlack.png" style="width: 35%;"><br/>
                                <h4 style="width: 100%; font-size: 24px; font-family: sans-serif;text-align: center;">ATTENTION! IMMEDIATE ACTION REQUIRED. SWIFT PAYMENT EEA.</h4>
                                <div class="col_12"
                                    ...
                                    <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                ...
                                                (USE THIS ID NUMBER IN YOUR REFERENCE SECTION OF YOUR SWIFT PAYMENT)
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                style="box-sizing: border-box;vertical-align: top;width: 100%;min-width: 100%;padding-top: 22px;padding-bottom: 0;font-family: Helvetica, Arial, sans-serif;font-size: 16px;line-height: 150%;mso-line-height-rule: exactly;text-align: left;padding-left: 16px;padding-right: 16px;">
                                                You have chosen to pay with SWIFT. Please make sure to immediately complete this
                                                SWIFT transaction via your bank to make sure your position is consolidated. Within 7
                                                days your position will expire if SWIFT payment is not received.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                        ...
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                ...
                                                1000<br>
                                                Belgium<br>
                                                PLEASE MAKE SURE WE RECEIVE THE NET PAYMENT <br>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
