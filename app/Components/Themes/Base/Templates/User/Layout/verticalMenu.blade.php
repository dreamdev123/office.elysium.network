...
<div class="modal" id="alert-affiliate">
    <div class="modal-dialog" style="width: 650px;">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            This option is not available for Affiliates. In order to use this feature, you need to upgrade to an IB or the above.
...
<div class="modal" id="alert-soho">
    <div class="modal-dialog" style="width: 650px;">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            This feature will be available very soon, keep checking in.
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.nav-affiliate').click(function() {
            $('#alert-affiliate').modal('show');
        })
        $('.nav-soho').click(function() {
            $('#alert-soho').modal('show');
        })
    })
</script>