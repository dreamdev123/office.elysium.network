...
<div class="page-wrapper">
    <!-- BEGIN HEADER -->
    <div class="page-header navbar navbar-fixed-top index">
        <!-- BEGIN HEADER INNER -->
        <div class="page-header-inner ">
            <!-- BEGIN LOGO -->
            <div class="page-logo">
                <a href="{{ scopeRoute('home') }}">
            ...
            <li class="timePieceHolder">
                <div class="month">MAR<span>2018</span></div>
                <div class="icon">
                    <i class="fa fa-clock-o"></i>
                    <span class="day">
                <span class="string">Thu</span>
            ...
            <?php
            // if(Request::url() == route('user.xoom'))
            ?>
            <!-- <img src="{{asset('images/XOOM.png')}}" style="width: 136px;padding-left: 13px;padding-top: 5px;" class="padding-left"/> -->
            @if($user->customer_id == 526792 && (Request::url() == route('user.soho') || Request::url() == route('user.soho.contentLibrary') || Request::url() == route('user.soho.videoLibrary') || Request::url() == route('user.soho.email') || Request::url() == route('user.soho.imageManagement') || Request::url() == route('user.soho.videoManagement')))
             <img src="{{asset('images/SOHO.png')}}" style="width: 136px; padding-left: 13px; padding-top: 10px;" class="padding-left"/>
            @endif
            ...
            <div class="top-menu">
                ...
                <ul class="nav navbar-nav pull-right">
                    <!-- <li class="bookmarks dropdown">
                        <button type="button" class="btn btn-sm btn-outline dropdown-toggle" data-toggle="dropdown"
                                aria-expanded="false">
                            <a href="#">
                                <span> <img src="{{asset('images/icons/bookmark.png')}}" style="width: 25px;" />{{ _t('general.Bookmarks') }}<i
                        ...
                        <div class="dropdown-menu bookMarks pull-right">
                            <div class="bookmarkContainer">
                                <h2 class="head">
                                    <i class="fa fa-star-half-full"></i>{{ _t('general.Bookmark_manager') }}
                                </h2>
                    ...
                    <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            ...
                            <span class="badge badge-default"> {{ loggedUser() ? loggedUser()->unreadNotifications()->count() : '0' }} </span>
                        </a>
                        <ul class="dropdown-menu">
                            <li class="external">
                                <h3>
                                    <span class="bold">{{ loggedUser() ? loggedUser()->unreadNotifications()->count() : '0' }} {{ _t('general.pending') }}</span>
                    ...
                    <li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true" aria-expanded="false">
                            ...
                            <span class="badge badge-default element">{{ getUnreadMail()->count() }}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <li class="external">
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            ...
                            <span class="username username-hide-on-mobile"> {{ loggedUser() ? loggedUser()->metaData->firstname : '' }}</span>
                            <i class="fa fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li>

                                <a href="{{ route(strtolower(getScope()).'.personalinfo') }}">
                            ...
                            <li>
                                <a href="javascript:;" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                    <i class="icon-key"></i> {{ _t('general.Log_Out') }} 
                                </a>
                                <form id="logout-form" action="{{ route(strtolower(getScope()).'.logout') }}" method="POST" style="display: none;">
                                    {{ csrf_field() }}
                                </form>
                            </li>
                        </ul>
                ...
                {{--<a href="{{ logoutLink() }}" class="dropdown-toggle">--}}
