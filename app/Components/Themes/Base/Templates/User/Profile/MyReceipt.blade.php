...
@include('_includes.profile_nav')
    <div class="row" style="margin-top: 40px;">
        <div class="col-sm-6 col-sm-offset-6">
            <button class="btn btn-primary download-invoice-pdf" style="float: right;"><i class="fa fa-download"></i>&nbsp;&nbsp; Print </button>
        </div>
    </div>
    <div id="invoice">
        <div class="row" style="margin-top: 40px;">
        ...
        <div class="row text-center" style="margin-top: 70px;">
            <div class="col-sm-3">
                <span class="old_package" style="font-size: 24px; cursor: pointer; display: none;" onclick="packageClick('prev')"><i class="fa fa-chevron-left"></i></span>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-sm-3">
                <span class="current_package" style="font-size: 24px; cursor: pointer; display: none;" onclick="packageClick('next')"><i class="fa fa-chevron-right"></i></span>
            </div>
        </div>
    ...
    <script>
        ...
        $('.download-invoice-pdf').on('click', function() {
            window.location.href = '{{route("user.download_invoice_pdf")}}?plan=' + current_position;
        })
    </script>
