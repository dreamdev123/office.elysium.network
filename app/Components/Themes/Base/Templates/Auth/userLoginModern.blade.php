...
<style type="text/css">
    #user-login h3, .checkbox-container .mb-1 {
...
<body class="login" id="user-login" style="background-size: cover; background-image:url({{ asset('images/TradingBackground.jpg') }}">
    ...
    <div class="row minvh-100" style="position: relative">
       <!--  <div class="col-lg-6 p-0 register-bg-container">
        ...
        <div class="col-lg-6 align-self-center text-center m-auto pt-5 pb-5">
            ...
            <p class="description-paragraph mb-5"><a href="{{route('user.register')}}" class="text-link create-account" style="font-size: 14px">{{ _t('auth.create_an_account') }}</a></p>
            <!-- <p class="description-paragraph mb-5"><a href="#maintenance" data-toggle="modal" class="text-link" style="font-size: 14px">{{ _t('auth.create_an_account') }}</a></p> -->
            <div class="row">
            ...
            <div class="col-12">
                <div class="login-copyright text-right">
                    <a href="{{ route('information.view', ['page' => 'copyright'])}}" target="_blank">
                        <p style="font-size: 14px; color: #585958">2020 © Brandfields LIMITED</p>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="padding:20px;">
            ...
            <div class="modal-body">
                ...
                <h4 style="text-align: center;">We are currently closed for registration and will resume on 1 May at 10:00am</h4>
            </div>
        </div>
