                       ...
                       {!! Form::open(['route' => 'admin.register','class' => 'registrationForm','id' => 'registrationForm', 'autocomplete' => 'off']) !!}
                        <div class="form-wizard">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="form-control optional" name="company_name" placeholder="Company Name"/>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group ">
                                                    <label class="control-label">Company Registration NR</label>
                                                    <input type="text" class="form-control optional" name="company_registration_nr" placeholder="Company Registration NR" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control optional" name="company_address" placeholder="Company Address" />
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Confirm You are UBO-Director</label>
                                                    <div class="radio-list">
                                                        <label class="radio-container">
                                                            <input type="checkbox" name="company_ubo_director"
                                                                   checked="checked"/>
                                                            <span class="checkbox-circle"></span>
                                                            <span class="checkbox-name">Confirm</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="form-actions">
                                <div class="col-lg-8 col-lg-offset-2">
                                    <button
                                       class="btn-action proceed ladda-button" style="display: none;" disabled>{{_t('register.paynow')}} <i class="fa fa-angle-right"></i></button>
                        ...
                        <div class="row footer_row" style="display: none;">
                               <div class="col-lg-10 col-lg-offset-2 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                                    <div class="mt-4 info" style="margin-left: auto;">
                                        ...
                                        <p class="footer_desc">Elysium Capital PLC OÜ<br>No.5, 17/F, Bonham Trade Centre, 50 Bonham Strand, Sheung Wan, Hong Kong</p>
                                    </div>
                                    <div class="mt-4 mb-4 info">
                                        <img id="safecharge" src="{{asset('/images/SwedenGrey.png')}}" class="footer-image mr-3" alt="index.ec">
