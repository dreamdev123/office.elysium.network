    ...
    public function leftMenus(MenuServices $menuServices)
    {
        registerFilter('leftMenus', function ($menus) use ($menuServices) {
            ...
            return $menus->merge($menuServices->menusFromRaw([
                [
                    'label' => ['en' => 'Sales & Commission', 'es' => 'Ventas', 'ru' => 'Продажи', 'ko' => '매상', 'pt' => 'Vendas', 'ja' => '売上高', 'zh' => '销售', 'vi' => 'Bán hàng', 'sw' => 'Mauzo', 'hi' => 'बिक्री', 'fr' => 'Ventes', 'it' => 'I saldi'],
                    'link' => '',
                    'route' => '',
                    'route_name' => 'report.salescommission',
                    'icon_image' => '',
