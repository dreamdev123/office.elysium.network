<form class="filterForm">
    <div class="filters row">
        @if(getScope() == 'admin')
            <div class="eachFilter operation col-md-3 col-sm-3">
                ...
                <input type="text" class="userFiller"
                       placeholder="{{ _mt($moduleId,'EarningReport.Enter_user_name') }}" value="Apricitas">
                <input type="hidden" name="filters[user_id]" id="user_id" value="830">
            </div>
        @endif
        <div class="eachFilter operation col-md-3 col-sm-3">
        ...
        <div class="eachFilter operation col-md-6" style="display: flex;align-items: center;padding-top: 35px;">
