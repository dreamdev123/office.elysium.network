<form class="filterForm">
    <div class="filters row">
        ...
        <div class="eachFilter operation col-md-3 col-sm-3">
            ...
            <input class="form-control" name="filters[dates]" id="dates" placeholder="Pick Date"   >
            <input type="hidden" name="filters[fromDate]" id="dateStart">
            <input type="hidden" name="filters[toDate]" id="dateEnd">
        </div>
        <div class="eachFilter operation col-md-3 col-sm-3">
...
<script>
    ...
    $(function () {
        ...
        if($('input[name="filters[dates]"]').length > 0){
