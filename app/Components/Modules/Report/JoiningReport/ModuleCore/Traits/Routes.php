    ...
    function setRoutes()
    {
        Route::group(['prefix' => 'admin', 'middleware' => 'Routeserver:admin'], function () {
            Route::group(['prefix' => 'report'], function () {
                ...
                Route::get('downloadJoiningReportExcel', 'JoiningReportController@downloadJoiningReportExcel')->name('joiningReport.download.excel');
                Route::get('downloadJoiningReportCsv', 'JoiningReportController@downloadJoiningReportCsv')->name('joiningReport.download.csv');
