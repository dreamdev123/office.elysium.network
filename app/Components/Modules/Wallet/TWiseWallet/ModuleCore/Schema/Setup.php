...
namespace App\Components\Modules\Wallet\TWiseWallet\ModuleCore\Schema;
...
class Setup
{
    ...
    {
        if (!Schema::hasTable('twisewallet')) {
            Schema::create('twisewallet', function (Blueprint $table) {
                $table->increments('id');
            ...
            Schema::table('twisewallet', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('twisewallet');
    }
}