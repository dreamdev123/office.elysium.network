...
namespace App\Components\Modules\Wallet\TWiseWallet\ModuleCore\Services;
...
class TWiseWalletServices
{
    ...
    {
        $gateway = $moduleServices->callModule('Payment-TransferWise');
        $attributes = [
            'payee' => $payee,
            'payer' => $payer,
            'gateway' => $gateway,
