...
use App\Components\Modules\Wallet\TWiseWallet\ModuleCore\Support\TransferCallback;
    ...
    function prepareTransferPayable(Request $request, PaymentServices $paymentServices)
    {
        ...
        foreach ($request->input('payee') as $each) {
            $attributes = [
                ...
                'total' => $actualAmount + array_sum(array_column($charges = defineFilter('PreTWiseWalletTransaction', [], 'transactionTotal', $each), 'amount')),
