...
namespace App\Components\Modules\Wallet\TWiseWallet\ModuleCore\Eloquents;
...
class User extends \App\Eloquents\User
{
    ...
    {
        return !$data ? $this->hasOne(TWiseWallet::class) : ($this->walletData()->save(new TWiseWallet($data)));
    }
    ...
    function getWalletId()
    {
        ...
        return $moduleService->callModule('Wallet-TWiseWallet')->moduleId;
    }
