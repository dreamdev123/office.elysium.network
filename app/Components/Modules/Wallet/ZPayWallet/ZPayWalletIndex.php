...
namespace App\Components\Modules\Wallet\ZPayWallet;
...
use App\Components\Modules\Wallet\ZPayWallet\Controllers\ZPayWalletController;
...
use App\Components\Modules\Wallet\ZPayWallet\ModuleCore\Traits\Hooks;
use App\Components\Modules\Wallet\ZPayWallet\ModuleCore\Traits\Routes;
...
/**
 * Class ZPayWalletIndex
 * @package App\Components\Modules\Wallet\ZPayWallet
 */
class ZPayWalletIndex extends WalletModuleAbstract implements WalletModuleInterface
{
    ...
    {
        ZPayWallet::create(['user_id' => $data['user']->id]);
    }
    ...
    {
        return "<div class='ewalletTranList'>" . app()->call([new ZPayWalletController, 'getMemberTransactionList']) . '</div>';
    }
}
