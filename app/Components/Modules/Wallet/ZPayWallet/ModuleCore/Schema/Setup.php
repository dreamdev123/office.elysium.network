...
namespace App\Components\Modules\Wallet\ZPayWallet\ModuleCore\Schema;
...
class Setup
{
    ...
    {
        if (!Schema::hasTable('zpaywallet')) {
            Schema::create('zpaywallet', function (Blueprint $table) {
                $table->increments('id');
            ...
            Schema::table('zpaywallet', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('zpaywallet');
    }
}