...
namespace App\Components\Modules\Wallet\ZPayWallet\ModuleCore\Eloquents;
...
class User extends \App\Eloquents\User
{
    ...
    {
        return !$data ? $this->hasOne(ZPayWallet::class) : ($this->walletData()->save(new ZPayWallet($data)));
    }
    ...
    function getWalletId()
    {
        ...
        return $moduleService->callModule('Wallet-ZPayWallet')->moduleId;
    }
