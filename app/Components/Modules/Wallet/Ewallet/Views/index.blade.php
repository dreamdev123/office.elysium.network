        ...
        <div class="row topRow">
            <div class="balance col-md-4">
                ...
                <div class="navigator">
                    ...
                    <div class="col-md-6 eachNav send @if(isset($walletConfig['transfer_provision']) && !$walletConfig['transfer_provision']) disabledBox @endif"
                         data-unit="transfer">
                        <div class="innerWrap">
                    ...
                    <div class="col-md-6 eachNav instruction">
                        <a class="download" href="{{ asset('Payout-Guide.pdf') }}" download>
                        <div class="innerWrap">
                            <i class="fa fa-file-download"></i>
                            <i class="fa fa-spin icon-refresh"></i>
                            <span>{{ _mt('Wallet-Ewallet','Ewallet.instruction') }}</span>
                        </div>
                        </a>
                    </div>
                </div>
