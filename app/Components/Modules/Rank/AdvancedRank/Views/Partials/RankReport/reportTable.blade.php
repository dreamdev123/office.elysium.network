...
<script type="text/javascript">
    ...
    $('.downloadExcel').click(function () {
        window.location.href = '{{ route('advancedRankReport.download.excel') }}?' + $('.filterForm').serialize();
    });

    // Download report as csv
    $('.downloadCsv').click(function () {
        window.location.href = '{{ route('advancedRankReport.download.csv') }}?' + $('.filterForm').serialize();
    });
