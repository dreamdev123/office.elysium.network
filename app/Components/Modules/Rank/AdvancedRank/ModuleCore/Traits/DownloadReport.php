...
use App\Exports\RankReportExport;
...
trait DownloadReport
{
    ...
    function downloadRankReportExcel(Request $request)
    {
        ...
        $fileName = 'RankReport-' . date('Y-m-d-h-i-s') . '.xlsx';

        return Excel::download(new RankReportExport($data), $fileName);
    }
    ...
    function downloadRankReportHistoryCsv(Request $request)
    {
        ...
        $fileName = 'RankReport-' . date('Y-m-d-h-i-s') . '.csv';
