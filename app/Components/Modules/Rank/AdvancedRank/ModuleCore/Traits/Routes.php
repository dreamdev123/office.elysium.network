    ...
    function setRoutes()
    {
        Route::group(['prefix' => 'admin', 'middleware' => 'Routeserver:admin'], function () {
            ...
            Route::group(['prefix' => 'advancedRank'], function () {
                ...
                Route::get('RankReportExcel', 'AdvancedRankController@downloadRankReportExcel')->name('advancedRankReport.download.excel');
                Route::get('RankReportCsv', 'AdvancedRankController@downloadRankReportHistoryCsv')->name('advancedRankReport.download.csv');
