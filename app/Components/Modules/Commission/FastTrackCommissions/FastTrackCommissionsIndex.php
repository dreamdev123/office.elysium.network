...
namespace App\Components\Modules\Commission\FastTrackCommissions;
...
use App\Components\Modules\Commission\FastTrackCommissions\ModuleCore\Support\Benefit;
use App\Components\Modules\Commission\FastTrackCommissions\ModuleCore\Traits\Hooks;
use App\Components\Modules\Commission\FastTrackCommissions\ModuleCore\Traits\Validations;
...
/**
 * Class FastTrackCommissionsIndex
 * @package App\Components\Modules\Commission\FastTrackCommissions
 */
class FastTrackCommissionsIndex extends BasicContract implements CommissionModuleInterface
{
    ...
    function bootMethods(CommissionServices $commissionServices)
    {
        ...
        schedule('Distribute Pending FTC', function () {
    ...
    function adminConfig($data = [])
    {
        ...
        return view('Commission.FastTrackCommissions.Views.adminConfig', $data);
    }
    ...
    /**
     * @param mixed $service
     * @return FastTrackCommissionsIndex
     */
