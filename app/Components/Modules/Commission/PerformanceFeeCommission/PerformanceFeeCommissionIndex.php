...
namespace App\Components\Modules\Commission\PerformanceFeeCommission;
...
use App\Components\Modules\Commission\PerformanceFeeCommission\ModuleCore\Support\Benefit;
use App\Components\Modules\Commission\PerformanceFeeCommission\ModuleCore\Traits\Hooks;
use App\Components\Modules\Commission\PerformanceFeeCommission\ModuleCore\Traits\Validations;
 ...
 * @package App\Components\Modules\Commission\PerformanceFeeCommission
 */
class PerformanceFeeCommissionIndex extends BasicContract implements CommissionModuleInterface
{
    use Validations;
    ...
    function adminConfig($data = [])
    {
        ...
        return view('Commission.PerformanceFeeCommission.Views.adminConfig', $data);
    }
    ...
    function commissionTable($commissions)
    {
        ...
        return view('Commission.PerformanceFeeCommission.Views.commissionTable', $data);
    }
}
