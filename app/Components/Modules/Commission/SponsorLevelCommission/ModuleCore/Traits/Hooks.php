...
trait Hooks
{
    ...
    function hooks()
    {
        registerAction('postRegistration', function ($data) {
            ...
            if ($data->get('result')['user']->repoData && $data->get('result')['user']->package->slug != 'affiliate' && $data->get('result')['user']->package->slug != 'client') {
                return $this->process([
        ...
        registerAction('postPackageUpgrade', function ($data) {
            ...
            if ($data->get('result')['user']->repoData && $currentPackage->slug != 'affiliate' && $currentPackage->slug != 'client') {
                return $this->process([
