...
namespace App\Components\Modules\Commission\GlobalBonusPool\ModuleCore\Support;
...
/**
 * Class Benefit
 * @package App\Components\Modules\Commission\GlobalBonusPool\ModuleCore\Support
 */
                ...
                if ($rankUserBenefit > 0 && checkAccess($rankUser->user_id, 'commission') && !$plugins->isAffiliate($beneficiary))
                    $data[] = [
                        ...
                        'benefit' => [
                            ...
                            'wallet' => $plugins->isPaidUser($beneficiary) ? $wallet->getRegistry()['moduleId'] : getModule('Wallet-PendingWallet')->moduleId,
