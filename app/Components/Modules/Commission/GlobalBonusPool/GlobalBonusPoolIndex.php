...
namespace App\Components\Modules\Commission\GlobalBonusPool;
...
use App\Components\Modules\Commission\GlobalBonusPool\ModuleCore\Support\Benefit;
use App\Components\Modules\Commission\GlobalBonusPool\ModuleCore\Traits\Validations;
...
/**
 * Class GlobalBonusPoolIndex
 * @package App\Components\Modules\Commission\GlobalBonusPool
 */
class GlobalBonusPoolIndex extends BasicContract implements CommissionModuleInterface
{
    use Validations;
    ...
    function bootMethods(CommissionServices $commissionServices)
    {
        ...
        schedule('Global Pool Bonus', function () {
            $this->process();
        });
    }
    ...
    function adminConfig($data = [])
    {
        ...
        return view('Commission.GlobalBonusPool.Views.adminConfig', $data);
    }
    ...
    function commissionTable($commissions)
    {
        ...
        return view('Commission.GlobalBonusPool.Views.commissionTable', $data);
    }
}
