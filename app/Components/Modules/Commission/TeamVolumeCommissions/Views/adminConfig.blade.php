...
@endforeach
<div class="row moduleConfig TeamVolumeCommissions">
    <div class="col-sm-12">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="row form-group">
                    <div class="col-md-3">
                        <label> {{ _mt($moduleId, 'TeamVolumeCommissions.Distribution_Type') }} </label>
                    </div>
                    <div class="col-md-9">
                        <div class="mt-radio-inline commisionRadio">
                            <label class="mt-radio">
                                <input type="radio" class="distribution_type" name="module_data[distribution_type]"
                                       value="flat"
                                       @if($config->get('distribution_type') == 'flat') checked @endif > {{ _mt($moduleId, 'TeamVolumeCommissions.Flat') }}
                            </label>
                            <label class="mt-radio">
                                <input type="radio" class="distribution_type" name="module_data[distribution_type]"
                                       value="percent"
                                       @if($config->get('distribution_type') == 'percent') checked @endif > {{ _mt($moduleId, 'TeamVolumeCommissions.Percent') }}
                            </label>
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-3">
                        <label>
                            {{ _mt($moduleId, 'TeamVolumeCommissions.Pair_Price') }} <span class="type"></span>
                        </label>
                    </div>
                    <div class="col-md-9">
                ...
                <div class="row pair_value_div">
                    <div class="col-md-3">
                        <label>
                            {{ _mt($moduleId, 'TeamVolumeCommissions.Pair_Value') }}
                        </label>
                    </div>
                    <div class="col-md-9">
                ...
                <div class="row form-group">
                    <div class="col-md-3">
                        <label> {{ _mt($moduleId, 'TeamVolumeCommissions.To_Wallet') }}</label>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row form-group">
                    <div class="col-md-3">
                        <label>{{ _mt($moduleId,'TeamVolumeCommissions.direct_referral_rule') }}
                        </label>
                    </div>
                    <div class="col-md-4">
                        <div class="moduleSwitch">
                            <label>{{ _mt($moduleId,'TeamVolumeCommissions.Off') }}</label>
                            <label class="switch">
                            ...
                            <label>{{ _mt($moduleId,'TeamVolumeCommissions.On') }}</label>
                        </div>
                    </div>
                </div>
                <div class="row form-group directReferralRuleDiv"
                    ...
                    <div class="col-md-3">
                        <label>
                            {{ _mt($moduleId,'TeamVolumeCommissions.direct_referral_required') }}
                        </label>
                    </div>
                    <div class="col-md-4 packagePriceBox">
                        <div class="row">
                            <div class="col-sm-5">
                                <label>{{ _mt($moduleId,'TeamVolumeCommissions.left') }}</label>
                            </div>
                            <div class="col-sm-7">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <label>{{ _mt($moduleId,'TeamVolumeCommissions.right') }}</label>
                            </div>
                            <div class="col-sm-7">
                ...
                <div class="row form-group">
                    <div class="col-md-3">
                        <label> {{ _mt($moduleId, 'TeamVolumeCommissions.Pair_Ceiling_Type') }}</label>
                    </div>
                    <div class="col-md-3">
                        <select class="form-control input-medium pair_ceiling_type"
                                name="module_data[pair_ceiling_type]">
                            <option value="none"
                                    @if($config->get('pair_ceiling_type') == 'none') selected @endif>{{ _mt($moduleId, 'TeamVolumeCommissions.None') }}</option>
                            <option value="monthly"
                                    @if($config->get('pair_ceiling_type') == 'monthly') selected @endif>{{ _mt($moduleId, 'TeamVolumeCommissions.Monthly') }}</option>
                            <option value="weekly"
                                    @if($config->get('pair_ceiling_type') == 'weekly') selected @endif>{{ _mt($moduleId, 'TeamVolumeCommissions.Weekly') }}</option>
                            <option value="daily"
                                    @if($config->get('pair_ceiling_type') == 'daily') selected @endif>{{ _mt($moduleId, 'TeamVolumeCommissions.Daily') }}</option>
                        </select>
                    </div>
                </div>
                <div class="pair_ceiling_div"
                    ...
                    <div class="row week_day form-group"
                        ...
                        <div class="col-md-3">
                            <label> {{ _mt($moduleId,'TeamVolumeCommissions.Week_Day') }}</label>
                        </div>
                        <div class="col-md-3">
                            <select class="form-control input-medium" name="module_data[week_day]">
                                <option value="Monday"
                                        @if($config->get('week_day') == 'Monday') selected @endif>{{ _mt($moduleId,'TeamVolumeCommissions.Monday') }}</option>
                                <option value="Tuesday"
                                        @if($config->get('week_day') == 'Tuesday') selected @endif>{{ _mt($moduleId,'TeamVolumeCommissions.Tuesday') }}</option>
                                <option value="Wednesday"
                                        @if($config->get('week_day') == 'Wednesday') selected @endif>{{ _mt($moduleId,'TeamVolumeCommissions.Wednesday') }}</option>
                                <option value="Thursday"
                                        @if($config->get('week_day') == 'Thursday') selected @endif>{{ _mt($moduleId,'TeamVolumeCommissions.Thursday') }}</option>
                                <option value="Friday"
                                        @if($config->get('week_day') == 'Friday') selected @endif>{{ _mt($moduleId,'TeamVolumeCommissions.Friday') }}</option>
                                <option value="Saturday"
                                        @if($config->get('week_day') == 'Saturday') selected @endif>{{ _mt($moduleId,'TeamVolumeCommissions.Saturday') }}</option>
                                <option value="Sunday"
                                        @if($config->get('week_day') == 'Sunday') selected @endif>{{ _mt($moduleId,'TeamVolumeCommissions.Sunday') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-3">
                            <label>{{ _mt($moduleId,'TeamVolumeCommissions.Pair_Ceiling_Based_On') }}</label>
                        </div>
                        <div class="col-md-3">
                            <select class="form-control input-medium pair_ceiling_based"
                                    name="module_data[pair_ceiling_based]">
                                <option value="pair_count"
                                        @if($config->get('pair_ceiling_based') == 'pair_count') selected @endif>{{ _mt($moduleId,'TeamVolumeCommissions.Pair_Count') }}</option>
                                <option value="amount"
                                        @if($config->get('pair_ceiling_based') == 'amount') selected @endif>{{ _mt($moduleId,'TeamVolumeCommissions.Amount') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-3">
                            <label><span class="pairCeilingBasedOnLabel">
                                @if($config->get('pair_ceiling_based') == 'amount') {{ _mt($moduleId,'TeamVolumeCommissions.Amount') }} @else
                                        {{ _mt($moduleId,'TeamVolumeCommissions.Pair_Count') }}
                ...
                <div class="form-group offset4">
                    <div class="col-md-1">
                        <button type="button" value="{{ _mt($moduleId,'TeamVolumeCommissions.Save') }}"
                                class="form-control ladda-button btn green button-submit" data-style="contract"
                                name="amount">{{ _mt($moduleId,'TeamVolumeCommissions.Save') }}</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(".pair_ceiling_based").change(function () {
        if ($(this).val() == 'pair_count')
            $('.pairCeilingBasedOnLabel').html("{{ _mt($moduleId,'TeamVolumeCommissions.Pair_Count') }}");
        else if ($(this).val() == 'amount') {
            $('.pairCeilingBasedOnLabel').html("{{ _mt($moduleId,'TeamVolumeCommissions.Amount') }}");
        }
    });
    ...
    $(function () {
        ...
        var validator = form.validate({
            ...
            messages: {
                'module_data[distribution_type]': "{{ _mt($moduleId,'TeamVolumeCommissions.Please_choose_distribution_type') }}",
                'module_data[pair_price]': {
                    required: "{{ _mt($moduleId,'TeamVolumeCommissions.Please_enter_pair_price') }}",
                    number: "{{ _mt($moduleId,'TeamVolumeCommissions.Invalid_pair_price') }}",
                },
                'module_data[wallet]': "{{ _mt($moduleId,'TeamVolumeCommissions.Please_select_wallet') }}",
                'module_data[pair_ceiling_type]': "{{ _mt($moduleId,'TeamVolumeCommissions.Please_pair_ceiling_type') }}",
                'module_data[pair_ceiling_based]': "{{ _mt($moduleId,'TeamVolumeCommissions.Please_select_pair_ceiling_based') }}",
                'module_data[pair_value]': {
                    required: "{{ _mt($moduleId,'TeamVolumeCommissions.Please_enter_pair_value') }}",
                    number: "{{ _mt($moduleId,'TeamVolumeCommissions.Invalid_pair_value') }}",
                },
            },
        ...
        $('.TeamVolumeCommissions .button-submit').click(function () {

            $('.ajaxValidationError').removeClass('ajaxValidationError');

            var successCallBack = function (response) {
                Ladda.stopAll();
                toastr.success("{{ _mt($moduleId,'TeamVolumeCommissions.Configuration_saved_successfully') }}");
            }
