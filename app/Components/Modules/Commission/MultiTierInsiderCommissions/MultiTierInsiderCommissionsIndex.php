...
namespace App\Components\Modules\Commission\MultiTierInsiderCommissions;
...
use App\Components\Modules\Commission\MultiTierInsiderCommissions\ModuleCore\Support\Benefit;
use App\Components\Modules\Commission\MultiTierInsiderCommissions\ModuleCore\Traits\Hooks;
use App\Components\Modules\Commission\MultiTierInsiderCommissions\ModuleCore\Traits\Validations;
...
/**
 * Class MultiTierInsiderCommissionsIndex
 * @package App\Components\Modules\Commission\MultiTierInsiderCommissions
 */
class MultiTierInsiderCommissionsIndex extends BasicContract implements CommissionModuleInterface
{
    ...
    function bootMethods(CommissionServices $commissionServices)
    {
        ...
        schedule('Distribute Pending MIC', function () {
    ...
    function adminConfig($data = [])
    {
        ...
        return view('Commission.MultiTierInsiderCommissions.Views.adminConfig', $data);
    }
    ...
    /**
     * @param mixed $service
     * @return MultiTierInsiderCommissionsIndex
     */
    ...
    function commissionTable($commissions)
    {
        ...
        return view('Commission.MultiTierInsiderCommissions.Views.commissionTable', $data);
    }
}
