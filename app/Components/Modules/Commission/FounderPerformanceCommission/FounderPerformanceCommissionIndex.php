...
namespace App\Components\Modules\Commission\FounderPerformanceCommission;
...
use App\Components\Modules\Commission\FounderPerformanceCommission\ModuleCore\Support\Benefit;
use App\Components\Modules\Commission\FounderPerformanceCommission\ModuleCore\Traits\Validations;
...
/**
 * Class DiamondBonusPoolIndex
 * @package App\Components\Modules\Commission\DiamondBonusPool
 */
class FounderPerformanceCommissionIndex extends BasicContract implements CommissionModuleInterface
{
    use Validations;
    ...
    function bootMethods(CommissionServices $commissionServices)
    {
        ...
        schedule('Distribute Founder Performance Commission', function () {
            $this->process();
        });
    }
    ...
    function adminConfig($data = [])
    {
        ...
        return view('Commission.FounderPerformanceCommission.Views.adminConfig', $data);
    }
    ...
    /**
     * @param mixed $service
     * @return FounderPerformanceCommissionIndex
     */
    ...
    function isUserEligible(User $user)
    {
        ...
        if ($user->rank->rank_id < 11) return false;
    ...
    function commissionTable($commissions)
    {
        ...
        return view('Commission.FounderPerformanceCommission.Views.commissionTable', $data);
    }
}
