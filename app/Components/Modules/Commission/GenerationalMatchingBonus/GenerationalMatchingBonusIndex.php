...
namespace App\Components\Modules\Commission\GenerationalMatchingBonus;
...
use App\Components\Modules\Commission\GenerationalMatchingBonus\ModuleCore\Support\Benefit;
use App\Components\Modules\Commission\GenerationalMatchingBonus\ModuleCore\Traits\Hooks;
use App\Components\Modules\Commission\GenerationalMatchingBonus\ModuleCore\Traits\Validations;
 ...
 * @package App\Components\Modules\Commission\GenerationalMatchingBonus
 */
class GenerationalMatchingBonusIndex extends BasicContract implements CommissionModuleInterface
{
    ...
    function bootMethods(CommissionServices $commissionServices)
    {
        ...
        schedule('Distribute Pending GMB', function () {
    ...
    function adminConfig($data = [])
    {
        ...
        return view('Commission.GenerationalMatchingBonus.Views.adminConfig', $data);
    }
    ...
    /**
     * @param mixed $service
     * @return GenerationalMatchingBonusIndex
     */
    ...
    function commissionTable($commissions)
    {
        ...
        return view('Commission.GenerationalMatchingBonus.Views.commissionTable', $data);
    }
}
