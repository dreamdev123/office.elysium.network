...
namespace App\Components\Modules\Commission\MultiTierEOSCommissions;
...
use App\Components\Modules\Commission\MultiTierEOSCommissions\ModuleCore\Support\Benefit;
use App\Components\Modules\Commission\MultiTierEOSCommissions\ModuleCore\Traits\Hooks;
use App\Components\Modules\Commission\MultiTierEOSCommissions\ModuleCore\Traits\Validations;
...
/**
 * Class MultiTierEOSCommissionsIndex
 * @package App\Components\Modules\Commission\MultiTierEOSCommissions
 */
class MultiTierEOSCommissionsIndex extends BasicContract implements CommissionModuleInterface
{
    ...
    function bootMethods(CommissionServices $commissionServices)
    {
        ...
        schedule('Distribute Pending MEC', function () {
    ...
    function adminConfig($data = [])
    {
        ...
        return view('Commission.MultiTierEOSCommissions.Views.adminConfig', $data);
    }
    ...
    /**
     * @param mixed $service
     * @return MultiTierEOSCommissionsIndex
     */
    ...
    function commissionTable($commissions)
    {
        ...
        return view('Commission.MultiTierEOSCommissions.Views.commissionTable', $data);
    }
}
