...
namespace App\Components\Modules\Commission\MultiTierEOSCommissions\ModuleCore\Support;
...
/**
 * Class Benefit
 * @package App\Components\Modules\Commission\MultiTierEOSCommissions\ModuleCore\Support
 */
class Benefit extends CommissionManager
{
    ...
    function prepareBeneficiaries()
    {
        ...
        if ($this->getReferral()->package->id == 1) {
