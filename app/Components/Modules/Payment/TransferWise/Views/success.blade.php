                                    ...
                                    <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                ...
                                                (USE THIS ID NUMBER IN YOUR REFERENCE SECTION OF YOUR {{$payment == 'IBAN'?'IBAN':'SWIFT'}} PAYMENT)
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                style="box-sizing: border-box;vertical-align: top;width: 100%;min-width: 100%;padding-top: 22px;padding-bottom: 0;font-family: Helvetica, Arial, sans-serif;font-size: 14px;line-height: 20px;mso-line-height-rule: exactly;text-align: left;padding-left: 16px;padding-right: 16px;">
                                                You have chosen to pay with {{$payment == 'IBAN'?'IBAN':'SWIFT'}}. Please make sure to immediately complete this
                                                {{$payment == 'IBAN'?'IBAN':'SWIFT'}} transaction via your bank to make sure your position is consolidated. Within {{$payment == 'IBAN'?3:7}}
                                        ...
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                style="box-sizing: border-box;vertical-align: top;width: 100%;min-width: 100%;padding-top: 22px;padding-bottom: 0;font-family: Helvetica, Arial, sans-serif;font-size: 14px;line-height: 20px;mso-line-height-rule: exactly;text-align: left;padding-left: 16px;padding-right: 16px;">
                                                Bank code: ({{$payment == 'IBAN'?'IBAN':'SWIFT'}} / BIC): TRWIBEB1XXX <br>
                                                {{$payment == 'IBAN'?'IBAN':'SWIFT'}}: BE21 9670 5753 4403
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                style="box-sizing: border-box;vertical-align: top;width: 100%;min-width: 100%;padding-top: 22px;padding-bottom: 0;font-family: Helvetica, Arial, sans-serif;font-size: 14px;line-height: 20px;mso-line-height-rule: exactly;text-align: left;padding-left: 16px;padding-right: 16px;font-weight: bold; text-decoration: underline;">
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                style="box-sizing: border-box;vertical-align: top;width: 100%;min-width: 100%;padding-top: 22px;padding-bottom: 0;font-family: Helvetica, Arial, sans-serif;font-size: 14px;line-height: 20px;mso-line-height-rule: exactly;text-align: left;padding-left: 16px;padding-right: 16px;">
                                                {{$context == 'register'?'Your account will be closed 7 days after your purchase, unless your payment is received and registered in our system on time':'Your account will be upgraded 7 days after your purchase, provided our payment is received and registered in our system'}}
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
