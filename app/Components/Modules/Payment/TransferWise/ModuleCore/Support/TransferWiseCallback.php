...
namespace App\Components\Modules\Payment\TransferWise\ModuleCore\Support\Transaction;
...
/**
 * Class ZotaCallback
 * @package App\Components\Modules\Payment\TransferWise\ModuleCore\Support\Transaction
 */
class TransferWiseCallback Extends Callback
{
    /**
     * @param $response
     * @return mixed|string
