...
<div class="b2b-failed">
    <h3>Oops You have failed with SafeCharge Payment Because {{$error}}</h3>
    <a href="{{route('user.home')}}"> <button class="btn green"> <i class="fa fa-arrow-circle-left"></i> Back To Home</button></a>
</div>
<style>
    .b2b-failed {
        width: 50%;
        margin: 22px auto;
        display: block;
        border: dashed 2px #a92609;
        padding: 30px 10px;
        border-left: solid 5px #a92609;
