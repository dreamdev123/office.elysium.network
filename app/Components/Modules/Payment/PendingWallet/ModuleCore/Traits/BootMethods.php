 ...
 * Trait BootMethods
 *
 * @package App\Components\Modules\Payment\PendingWallet\ModuleCore\Traits
 */
trait BootMethods
{
    /**
    ...
    {
        $this->setWallet(callModule('Wallet-PendingWallet'));

        Gate::define('pendingWalletTransaction', function () use ($paymentServices) {
