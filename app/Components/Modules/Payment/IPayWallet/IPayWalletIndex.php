...
class IPayWalletIndex extends PaymentModuleAbstract
{
     ...
     * @return array
     */
    function processRequestedPayout($amount, $requestID)
    {
        $payoutRequest = PayoutRequest::find($requestID);
        ...
        $params = array(
            ...
            'PartnerBatchID'    => uniqid('Batch_id_'),
            'PoolID'            => '',
            'arrAccounts'       => $account_to_load,
            'AutoLoad'          => true,
        ...
        if($ips_response->response->m_Code == -2)
        {
            return [
