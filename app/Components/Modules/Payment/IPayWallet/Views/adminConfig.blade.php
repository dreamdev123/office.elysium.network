        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <span aria-hidden="true"
                      class="icon-note"></span> IPay Configuration
            </div>
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">MerchantId
                        <span class="required" aria-required="true"> * </span>
                    </label>
                    <div class="col-md-4">
                        <input type="text" value="{{ $config->get('merchantId') }}" class="form-control"
                               name="module_data[merchantId]">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">Merchant Password
                        <span class="required" aria-required="true"> * </span>
                    </label>
                    <div class="col-md-4">
                        <input type="text" value="{{ $config->get('merchantPassword') }}" class="form-control"
                               name="module_data[merchantPassword]">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <select name="module_data[currency]" class="form-control">
                            <option value="USD" {{$config->get("currency") == "USD"?"selected":""}}>USD</option>
                            <option value="EUR" {{$config->get("currency") == "EUR"?"selected":""}}>EUR</option>
                        </select>
                    </div>
                </div>
