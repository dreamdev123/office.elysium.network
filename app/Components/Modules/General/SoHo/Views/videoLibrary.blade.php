...
@section('content')
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('slick/slick-theme.css') }}"/>
				...
				<div class="newSoho-custom-container">
					...
					@if (count($networkFileNames) > 0)
						...
						<div class="video-item-wrapper">
							<video controls>
							  <source src="{{ asset($filename['src']) }}#t=1" type="video/mp4">
    ...
    $('.network-video-btn').on('click', function() {
    	...
    	window.location.href = '{{ scopeRoute('soho.downloadSohoFile') }}?type=video&brand=network&filename='+selectedVideoName;
    })
    ...
    $('.capital-video-btn').on('click', function() {
    	...
    	window.location.href = '{{ scopeRoute('soho.downloadSohoFile') }}?type=video&brand=capital&filename='+selectedVideoName;
    })
    ...
    $('.insider-video-btn').on('click', function() {
    	...
    	window.location.href = '{{ scopeRoute('soho.downloadSohoFile') }}?type=video&brand=insider&filename='+selectedVideoName;
    })
  </script>
