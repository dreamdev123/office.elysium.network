                ...
                <div class="row holdingSettings">
                    ...
                    <div class="col-sm-12">
                        <div class="holdingSwitch checkbox">
                            ...
                            <label style="font-size: 12px;">{{ _mt($moduleId,'HoldingTank.off_comment') }}</label><br/>
                            <label style="font-size: 12px;">{{ _mt($moduleId,'HoldingTank.on_comment') }}</label>
                        </div>
                    </div>
        ...
        <div class="col-sm-3">
            <div class="row holdingNote">
                <form class="placementForm" action="">
                    ...
                    <div class="col-sm-12">
                        <div class="Note">
                            <p>*All enrollees will be placed on the side of the tree as selected  </p>
                        </div>
                    </div>
                    <div class="col-sm-12">
...
>>>>>>> e0b1f16394a256bda62d3ab3ddc6ade7059b8d9b
    ...
    <div class="holdingTankWrapper">
        <div class="col-md-12 filterUser">
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function loadUserStatus() {
            simulateLoading('.filterUser');
            $.post('{{ scopeRoute('holdingTank.userStatus') }}', $('.filterForm').serialize(), function (response) {
