<div class="filters row" style="display: none">
    <form class="filterForm">
        ...
        <div class="eachFilter operation col-sm-3 col-sm-offset-3">
        ...
        <div class="eachFilter operation col-sm-3">
            <button type="button" class="btn blue filterRequest ladda-button" data-style="contract" style="display: none">
                            <span class="ladda-label">
                            <i class="fa fa-filter"></i>{{ _mt($moduleId,'HoldingTank.filter') }}
                            </span>
                <span class="ladda-spinner"></span><span class="ladda-spinner"></span>
            </button>
            <button type="button" class="btn blue filterRequest1 ladda-button" data-style="contract">
                            <span class="ladda-label">
                            <i class="fa fa-filter"></i>{{ _mt($moduleId,'HoldingTank.filter') }}
                            </span>
                <span class="ladda-spinner"></span><span class="ladda-spinner"></span>
