...
@section('content')
    <div class="modal fade" id="upgrade_content" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <p style="text-align: justify; margin-left: auto !important; margin-right: auto !important; max-width: 450px;">This transaction will not be successful till full payment is made. After making a payment, please let the Support (<span class="text-primary">support@elysiumnetwork.io</span>) know that the payment was done successfully. Thank you</p>
                </div>
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">
                            {{  
                                _mt($moduleId,'PackageUpgrade.package_upgrade') 
                            }}
                        </span>
                    </div>
                </div>
                <div class="portlet-body form">
                    ...
                    @if($packages->count())
                        ...
                        <div class="form-wizard">
                            ...
                            <div class="paymentGatewaysWrapper" id="payment_result"></div>
                            ...
                            <div class="form-actions actionButtons">
                                <div class="row">
                                    <div class="col-offset-3 col-md-12">
                                        ...
                                        <a href="javascript:"
                                           class="btn green proceed package_upgrade" style="display: none; float: right; width: 140px;">Pay Now
                                            <i class="fa fa-angle-right"></i>
                                        </a>
                                    </div>
                                </div>
