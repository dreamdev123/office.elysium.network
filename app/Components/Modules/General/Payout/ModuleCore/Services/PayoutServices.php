...
class PayoutServices
{
    ...
    {
        return ['user_id', 'request_amount', 'wallet', 'gateway', 'remark', 'status', 'transaction_id', 'account', 'bank_name', 'bank_address', 'bank_country', 'content', 'reference'];
    }
    ...
    function cancelRequest($id)
    {
        ...
        $module_id = $payoutRequest->transaction->operation->from_module;
        ...
        return getModule((int)$module_id)->updateCache(loggedUser());
    }
