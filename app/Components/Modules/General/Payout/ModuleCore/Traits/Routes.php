            ...
            Route::group(['prefix' => $scope, 'middleware' => "Routeserver:$scope"], function () use ($scope) {
                ...
                Route::group(['prefix' => 'payout'], function () use ($scope) {
                    ...
                    if (($scope == 'admin') || ($scope == 'employee')) {
                        ...
                        Route::get('releaseRequestedRemotePayouts/{username}/{request_amount}', 'PayoutController@releaseRequestedRemotePayouts')->name("$scope.payout.requests.remoterelease");
                    ...
                    if ($scope == 'user') {
                        ...
                        Route::post('getRequestSuccessView', 'PayoutController@getRequestSucessView')->name("$scope.payout.request.success");
