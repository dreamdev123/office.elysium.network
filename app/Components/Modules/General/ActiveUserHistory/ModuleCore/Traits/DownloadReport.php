...
trait DownloadReport
{
    ...
    function downloadRankReportPdf(Request $request, PDF $pdf)
    {
        ...
        $data = [
            ...
            'reportName' => _mt($this->module->moduleId, 'ActiveUserHistory.rank_report'),
            'displayLogo' => true
        ];

        $pdf->loadHTML(view('Rank.ActiveUserHistory.Views.Partials.rankReport.exportView', $data));
    ...
    function downloadRankReportExcel(Request $request)
    {
        ...
        $excel = Excel::create($fileName, function ($excel) use ($data) {
            $excel->sheet('Excel', function ($sheet) use ($data) {
                $sheet->loadView('Rank.ActiveUserHistory.Views.Partials.rankReport.exportView', $data);
            });
    ...
    function printRankReportHistory(Request $request)
    {
        ...
        return view('Rank.ActiveUserHistory.Views.Partials.rankReport.exportView', $data);
    }
    ...
    function downloadRankAchievementHistoryReportPdf(Request $request, PDF $pdf)
    {
        $data = [
            ...
            'moduleId' => $this->module->moduleId,
            'reportName' => _mt($this->module->moduleId, 'ActiveUserHistory.rank_achievement_report'),
            'displayLogo' => true
        ];

        $pdf->loadHTML(view('Rank.ActiveUserHistory.Views.Partials.RankAchievementReport.exportView', $data));
    ...
    function downloadRankAchievementHistoryReportExcel(Request $request)
    {
        ...
        $excel = Excel::create($fileName, function ($excel) use ($data) {
            $excel->sheet('Excel', function ($sheet) use ($data) {
                $sheet->loadView('Rank.ActiveUserHistory.Views.Partials.RankAchievementReport.exportView', $data);
            });
        })->store('xlsx', storage_path('app' . DIRECTORY_SEPARATOR . 'public'));
    ...
    function printRankAchievementHistoryReport(Request $request)
    {
        ...
        return view('Rank.ActiveUserHistory.Views.Partials.RankAchievementReport.exportView', $data);
    }
