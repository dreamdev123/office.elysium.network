<div class="personalizedPanel personalizeBinaryPoint" data-target="binaryPoint">
    ...
    <form name="changePersonalizeBinaryPointForm" id="changePersonalizeBinaryPointForm_{{ $userId }}">
        ...
        <div class="eachField row">
            <div class="col-md-4">
                <!-- <label>{{ _mt($moduleId,'BinaryPointTransaction.distribute_to_upline') }}</label> -->
            </div>
            <div class="col-md-5">
                <input type="hidden" class="prettySwitch" name="distribute_to_upline">
...
<script>
    ...
    $(function () {
        ...
        $('body').off('click', '.personalizeBinaryPoint .submitForm')
            .on('click', '.personalizeBinaryPoint .submitForm', function () {
