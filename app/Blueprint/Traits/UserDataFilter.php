...
trait UserDataFilter
{
    ...
    function basicData()
    {
        return ['username', 'password', 'email', 'phone', 'customer_id', 'sponsor_id', 'expiry_date', 'insider_expiry_date', 'package_id','signup_package'];
    }
    ...
    function formatRepoData(Collection $data, User $user)
    {
        ...
        $position =  $data->get('position')?$data->get('position'):defineFilter('positionFilter', $data->get('position'), 'Plan', $sponsorId);
    ...
    function allowedMetaFields()
    {
        return array(
            ...
            'company_name','company_registration_nr','company_address','company_ubo_director',
        );
    }
}
