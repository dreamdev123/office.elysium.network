...
trait RegistersUsers
{
    ...
    public function showRegistrationForm(Request $request, CartServices $cartServices)
    {
        ...
        return view('Auth.registerModern', $data);
    }
