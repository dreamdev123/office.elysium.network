...
class CronServices
{
     ...
     * @return $this|Model
     */
    function addStartCronHistory($cronJob)
    {
        return CronHistory::create([
            'cron_id' => $cronJob->id,
            'response' => 'Start '.$cronJob->task,
        ]);
    }
     ...
     * @return $this|Model
     */
    function addCompleteCronHistory($cronJob)
    {
        return CronHistory::create([
            'cron_id' => $cronJob->id,
            'response' => 'Complete '.$cronJob->task,
        ]);
    }
}