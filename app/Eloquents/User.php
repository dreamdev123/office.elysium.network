...
class User extends Authenticatable
{
    ...
    function sponsor()
    {
        return $this->repoData ? ($this->repoData->sponsorUser ?$this->repoData->sponsorUser: static::companyUser()) : $this->userSponsor;
...
/**
    ...
    function transferwise(){
        return $this->hasOne(TransferWiseTransaction::class, 'reference', 'customer_id');
    }
     ...
     */
    function b2b(){
        return $this->hasOne(B2BPayTransaction::class, 'reference_id', 'customer_id');
    }
}