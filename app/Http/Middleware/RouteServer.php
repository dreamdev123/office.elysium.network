...
class RouteServer
{
    ...
    public function handle($request, Closure $next, $scope = '')
    {
        ...
        // }
        // else if(Route::currentRouteName() != 'comming')
        // {
        //     if($scope != 'admin' && Route::currentRouteName() != 'home')
        //     {
        ...
        // $externalMailServices->sendmailchimp();

        if(loggedUser())
        {
            defineAction('checkuser',null,loggedUser());
        }
