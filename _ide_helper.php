 ...
 * Generated for Laravel 5.6.40 on 2024-09-22 23:06:29.
 *
...
namespace App\Blueprint\Facades { 
    ...
    class UserServer {
         ...
         * @static 
         */ 
        public static function expire_alarm()
        {
                        /** @var \App\Blueprint\Services\UserServices $instance */
                        return $instance->expire_alarm();
        }
         ...
         * @static 
         */ 
        public static function increaseexpire($user, $transaction)
        {
                        /** @var \App\Blueprint\Services\UserServices $instance */
                        return $instance->increaseexpire($user, $transaction);
        }
