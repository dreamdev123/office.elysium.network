...
server = "wss://marketplace.shoclef.com";
						...
						janus.attach(
							{
								...
								onlocaltrack: function(track, on) {
									...
									if(track.kind === "audio") {
										...
										$('#videoleft').append('<video class="centered" id="myvideo' + trackId + '" width="100%" height="100%" autoplay playsinline muted="muted"/>');
								...
								onremotetrack: function(track, mid, on) {
									...
									if(track.kind === "audio") {
										...
										$('#videoright').append('<video class="centered" id="peervideo' + mid + '" width="100%" height="100%" autoplay playsinline/>');
										Janus.attachMediaStream($('#peervideo' + mid).get(0), stream);
