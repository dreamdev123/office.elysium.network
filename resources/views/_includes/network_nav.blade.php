...
<div class="row personalInfoGridWrapper">
    ...
    <div class="col-sm-2">
        <a href="{{ route('user.tree.genealogyTree1') }}" class="infoGrid @if (Request::url() === (route('user.tree.genealogyTree'))) active @endif">
    ...
    <div class="col-sm-2">
        <a href="{{ route('user.tree.genealogyTree1', 'sponsor') }}" class="infoGrid @if (Request::url() === (route('user.tree.genealogyTree1', 'sponsor'))) active @endif">
            <h3>SPONSOR</h3>
        </a>
    </div>
    <div class="col-sm-2">
