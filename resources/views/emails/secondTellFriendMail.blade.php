                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width: 100%;min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" width="100%" class="mcnTextContentContainer">
                    <tbody>
                    	<tr>
	                        ...
	                        <td valign="top" class="mcnTextContent" style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #656565;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">
	                        	{{--<img src="{{asset('images/LogoNetworkRedBlack.png')}}" style="max-width: 250px; margin-bottom: 30px;"><br/>--}}
                            Did you get my e-mail? {{$data['to_name']}}<br>
	                        </td>
	                    </tr>
                    	<tr>
                ...
                <table style="max-width: 100%;min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;" valign="top">
                        	Hello {{$data['to_name']}}! {{$data['from_name']}} here.<br>
                        	<br>
                        	...
                        	<br>
													Click <a href="https://www.elysiumnetwork.io/{{$data['customer_id']}}">here</a> to find out.<br>
                        	<br>
                        	...
                        	<br>
													With warm regards {{$data['from_name']}}<br>
                        	<br>
                        	...
                        	<br>
													You received this email because you've either subscribed or
													been referred manually by a friend/acquaintance via "Tell-A-Friend".<br>
                        	<br>
													If you no longer want to receive these emails, please click on the link below:<br>
                        	<br>
													Click <a href="{{route('newsoho.unSubscriptionCheck')}}?tId={{$data['tId']}}">here</a> to unsubscribe - thanks! :-) It's instant and permanent.<br>
                        	<br>
