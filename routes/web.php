...
// Route::get('/elysium-equiti-v2', function() {
//   return view('index1');
// });
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['localeSessionRedirect', 'localizationRedirect', 'CustomMiddlewares']], function () {
    ...
    // Route::any('/shareImage', 'Share\newSoho\newSohoController@shareImage')->name('newsoho.shareImage');
    Route::any('/unSubscriptionCheck', 'Share\newSoho\newSohoController@unSubscriptionCheck')->name('newsoho.unSubscriptionCheck');
    Route::any('/calcInsiderCommission/{insiderUserId?}', 'Share\newSoho\newSohoController@calcInsiderCommission')->name('insider.commission');
    
    Route::get('comming','Controller@comming');
     ...
     Route::get('home', function () {
        ...
        if($user)
        {
            $usertype = $user->userType->title?loggedUser()->userType->title:'user';
        ...
        Route::group(['middleware' => 'auth'], function () {
            ...
            Route::group(['namespace' => 'Management', 'prefix' => 'manage'], function () {
                ...
                Route::group(['prefix' => 'members'], function () {
                    ...
                    Route::post('profileHidename', 'MemberController@profileHidename')->name('management.members.profileHidename');
                    ...
                    Route::post('ipayoutAccountUpdate', 'MemberController@ipayoutAccountUpdate')->name('management.members.ipayoutAccountUpdate');
                    Route::post('ipayoutUsernameUpdate', 'MemberController@ipayoutUsernameUpdate')->name('management.members.ipayoutUsernameUpdate');
                    Route::post('downgradePackage', 'MemberController@downgradePackage')->name('management.members.downgradePackage');
                    Route::post('reInstatePackage', 'MemberController@reInstatePackage')->name('management.members.reInstatePackage');
                    Route::post('unSubscribeEmail', 'MemberController@unSubscribeEmail')->name('management.members.unSubscribeEmail');
                });
                // Task management
    ...
    Route::group(['namespace' => 'User', 'prefix' => 'user', 'middleware' => ['CustomMiddlewares', 'lock', 'CheckForMaintenanceMode', 'Routeserver:user']], function () {
        Route::group(['middleware' => 'auth'], function () {
            ...
            Route::post('holdingTankActive','IndexController@holdingTankActive')->name('user.holdingTankActive.save');
            Route::post('autoplacementActive','IndexController@autoplacementActive')->name('user.autoplacementActive.save');
            //Mail management
            Route::group(['namespace' => 'Mail', 'prefix' => 'mail'], function () {
            ...
            Route::group(['namespace' => 'Profile', 'prefix' => 'personalinfo'], function () {
                ...
                Route::any('/my_receipt','ProfileController@my_receipt')->name('user.my_receipt');
                Route::any('/downlaod-invoice-pdf','ProfileController@download_invoice_pdf')->name('user.download_invoice_pdf');
                Route::any('/get-package','ProfileController@get_package')->name('user.get_package');
            ...
            //New Soho section
            // Route::group(['namespace' => 'newSoho', 'prefix' => 'newsoho'], function () {
            //     Route::get('/', 'newSohoController@contentCreator')->name('newsoho');
            //     Route::post('/makeSohoImage', 'newSohoController@makeSohoImage')->name('newsoho.makeSohoImage');
            //     Route::any('/download', 'newSohoController@downloadSohoFile')->name('newsoho.downloadSohoFile');
            //     Route::get('/contentLibrary', 'newSohoController@contentLibrary')->name('newsoho.contentLibrary');
            //     Route::get('/videoLibrary', 'newSohoController@videoLibrary')->name('newsoho.videoLibrary');
            //     Route::get('/email', 'newSohoController@email')->name('newsoho.email');
            //     Route::post('/sendEmail', 'newSohoController@sendEmail')->name('newsoho.sendEmail');
            //     Route::get('/imageManagement', 'newSohoController@imageManagement')->name('newsoho.imageManagement');
            //     Route::get('/videoManagement', 'newSohoController@videoManagement')->name('newsoho.videoManagement');
            //     Route::post('/uploadImage', 'newSohoController@uploadImage')->name('newsoho.uploadImage');
            //     Route::post('/uploadVideo', 'newSohoController@uploadVideo')->name('newsoho.uploadVideo');
            //     Route::post('/storeBrand', 'newSohoController@storeBrand')->name('newsoho.storeBrand');
            //     Route::any('/removeFile', 'newSohoController@removeFile')->name('newsoho.removeFile');
            //     Route::any('/shareImage', 'newSohoController@shareImage')->name('newsoho.shareImage');
            // });

            //New Xoom section
            Route::group(['namespace' => 'newXoom', 'prefix' => 'newxoom'], function () {
                Route::get('/', 'newXoomController@index')->name('user.newxoom');
                Route::get('/videoRoom', 'newXoomController@videoRoom')->name('user.newxoom.videoRoom');
            //     Route::post('/makeSohoImage', 'newSohoController@makeSohoImage')->name('newsoho.makeSohoImage');
            //     Route::any('/download', 'newSohoController@downloadSohoFile')->name('newsoho.downloadSohoFile');
            //     Route::get('/contentLibrary', 'newSohoController@contentLibrary')->name('newsoho.contentLibrary');
            //     Route::get('/videoLibrary', 'newSohoController@videoLibrary')->name('newsoho.videoLibrary');
